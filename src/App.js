...
function Search({ query, setQuery }) {
  ...
  useKey(
    "Enter",
    function () {
      // This whole function is the actionCallback function in useKey
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  useEffect(
    function () {
      ...
      return function () {
        //clean up function for reverting back the page title
        ...
        <>
          ...
          <section>
            <div className="rating">
              ...
              {userRating > 0 && (
                <btn className="btn-add" onClick={() => handleAdd(movie)}>
                  + Add to list
                </btn>
              )}
            </div>
